...
<main style="position:relative; " id="mainAccueil" class="accueil mainWithoutModal">
    <div id="modal_content">
        <div style= relative; class="modal-wrapper">
            <div style=" padding-bottom:50px; padding-top:50px;" class="modal" id="modalFormInscription" > 
            <?php if ((!$estConnecte) || ($role === 'admin')) {include '../composants/modal/inscription.php';} ?> </div>
        ...
        </div> <div style="display:block;" class="modal-spacer"></div>
        </div>
         <div class="modal-wrapper">
