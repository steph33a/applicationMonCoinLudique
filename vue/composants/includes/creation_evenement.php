 <form style="width:700px; background-color: #F8F3EB; opacity: 0.7; border: #704405 solid 1px; display:flex; flex-direction:column; justify-content:space-between; align-items:center;margin:25px auto;" class="formulaire" id="formulaireCreationEvenement" enctype="multipart/form-data" action="../../controller/controller.php" method="POST">
        ...
        <div style="margin-top:25px; display:flex; flex-direction:row; justify-content:space-between; gap:20px;  width:700px" id="suppDetailsEvenement" class="" style=" margin-top: 20px;">
            <div style ="display:flex; flex-direction:column; justify-content:space-between; gap:20px;align-items:center; width:305px;" id="choixProfil">
                ...
                <div class="field-group">
                    ...
                    value="<?php if ($mode=='modificationEvenement') {echo $evenementSelected['ageRequis'];} ?>"
                    type="text"
                    name="ageRequis"
        ...
        <div class="details-evenement" id="formulaireContent">
            ...
            <div class="form-group">
                ...
                <input type="date" name="dateEvent"class="dateEvent formElement" id="dateEventCreateEvent" placeholder="jj/mm/aaaa" autofocus required
                    value="<?php if ($mode=='modificationEvenement') echo $evenementSelected['dateEvenement']; ?>">
            ...
            <div class="form-group">
                ...
                <input class="heureEvent formElement" name="heureEvent" type="time" id="heureEventCreateEvent"
                    value="<?php if ($mode=='modificationEvenement') echo $evenementSelected['heureEvenement']; ?>" placeholder="hh:mm" required>
            ...
            <div class="form-group">
                ...
                <input class="titreEvent formElement" name="titreEvent" type="text" id="titreEventCreateEvent"
                    value="<?php if ($mode=='modificationEvenement') echo $evenementSelected['titreEvenement']; ?>" placeholder="titre de la soirée">
            ...
            <div class="form-group">
                ...
                <input class="jeuxThemesEvent formElement" name="jeuxThemesEvent" type="textarea" id="jeuxThemesEventCreateEvent" placeholder="nom jeu1,nom jeu2,nom jeu3..."  
                    value="<?php if ($mode=='modificationEvenement') echo $evenementSelected['jeuxThemesEvent']; ?>">
    ...
    <div class="<?php if ($role=="groupe") {echo "divCreateEventForGroupe";}?>" style="width:500px;margin:25px auto ; "id="informationsProfilOrganisateur">
        ...
        <div style="display:flex; flex-direction:row; justify-content:flex-end; gap:20px;">
            ...
            <input style=" width:200px;" type="text" id="rueCreateEvent" name="rueEvent" class="rueEvent formElement" value="<?php if ($mode=="modificationEvenement") {echo $evenementSelected["rueEvenement"];}?>">
             <p class="rueEventCommentaire"></p>
        </div>
            <div style="display:flex; flex-direction:row; justify-content:flex-end;gap:20px;">
                <label style=" width:50px;"for="numCreateEvent">N°<span><?php if ($role=="groupe") {echo " * ";}?></span></label>
                <input style=" width:100px;"type="text" id="numCreateEvent" name="numRueEvent"class="numRueEvent formElement" value="<?php if ($mode=="modificationEvenement") {echo $evenementSelected["numAdresse"];}?>">
        ...
        <div style="display:flex; flex-direction:row; justify-content:flex-end; gap:20px; margin-top:15px;">
            <div style="display:flex; flex-direction:row; justify-content:space-between;">
                ...
                <input style=" width:200px;" type="text" id="villeCreateEvent" name="villeEvent" class="villeEvent formElement" value="<?php if ($mode=="modificationEvenement") {echo $evenementSelected["ville"];}?>">
            ...
            <div style="display:flex; flex-direction:row; justify-content:flex-end;gap:20px;">
                ...
                <input style="width:100px;"type="" id="codePostalCreateEvent" name="codePostalEvent" class="codePostalEvent formElement" value="<?php if ($mode=="modificationEvenement") {echo $evenementSelected["codePostal"];}?>">
        ...
        <div style="display:flex; flex-direction:row; justify-content:flex-end; margin-top:15px;">
            ...
            <input type="email" id="mailCreateEvent" class="emailEvent formElement" name="emailEvent" placeholder="mail de l'organisateur" value="<?php if ($mode=="modificationEvenement") {echo $evenementSelected["mail"];} ?> required">
              <p class="mailEventCommentaire"></p>
        </div>

        <div style="display:flex; flex-direction:row; justify-content:flex-end;margin-top:15px;">
            <label for="numberPhoneCreateEvent">Tel<span><?php if ($role=="groupe") {echo " * ";}?></span></label>
            <input type="" id="numberPhoneCreateEvent" class="numberPhoneEvent formElement" name="numberPhoneEvent" placeholder="numéro de GSM ou téléphone" value="<?php if ($mode=="modificationEvenement") {echo $evenementSelected["numberPhone"];}?>">
        ...
        <div style="display:flex; flex-direction:row; justify-content:flex-end; margin-top:15px;">
         ...
         <div style="display:flex; flex-direction:row; justify-content:flex-end; margin-top:15px;">
            ...
            <input type="text" id="discussionGroupName" name="discussionGroupName" class="discussionGroupEvent formElement" placeholder="nom du groupe de discussion" value="<?php if ($mode == 'modificationEvenement') { echo $evenementSelected['groupe_discussion']; } ?>">
