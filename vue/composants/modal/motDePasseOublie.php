        ...
        <form style="width:620px; min-height: 448px;background-color: #FFFFFF; display:flex; flex-direction:column; justify-content:space-between; align-items:center;"class="formulaire" id="formulaireMotDePasseOublie" action="../../controller/controller.php" method="POST">
            <div style=" display:flex; flex-direction:column; justify-content:space-between;   width:305px">
               ...
               <?php } ?>
                ...
                <p class="commentaire displayNone" ></p>

                <label style="text-align: left;margin-top: 25px;">Quel est votre jeu préféré</label>
                <input  class="formElement"type="text" id="jeuPrefereUser" name="jeuPrefereUser" min="2" placeholder="nom du film préféré" required autofocus>
                
                <p class="commentaire displayNone" id="jeuPrefereUserCommentaire"></p>
                <!-- prénom -->
                ...
                <p class="commentaire displayNone" id="chanteurPrefereCommentaire"></p>
                <?php if (isset($_SESSION['id'])) { ?>
              ...
              <?php  } else { ?>
                     <input style=" margin-top: 25px;width:114px; height:40px;background-color: #6EBA46; color: #FFFFFF; font-size:18px; font-weight: 600; font-family: 'Nunito Sans', sans-serif;" class="formElement" type="submit" value="Envoyer" name="btnRecuperationDeMotDePasse" id="btnEnvoiReponsesRecupMotDePasse">
                <?php
                }
             ?>
